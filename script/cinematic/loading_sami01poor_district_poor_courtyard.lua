...
cinematicName = "cinematic.LoadingSami01PoorDistrictPoorCourtyard";
...
function narratorLineTrauma2_2()
	...
	nil, 12000, 700, cinematicName .. ".narratorLineTrauma2_3()")
end
...
function narratorLineTrauma3_2()
	cinematic.CinematicUtil.playSpeech("Play_shadwenstory_b1_02_shadwen", 
	nil, 12000, 700, cinematicName .. ".narratorLineTrauma3_3()")
end
...
function narratorLineTrauma4_1()
	...
	nil, 6000, 700, cinematicName .. ".narratorLineTrauma4_2()")
end
...
function narratorLineTrauma5_1()
	...
	nil, 1000, 700, cinematicName .. ".narratorLineTrauma5_2()")
end
...
function narratorLineTrauma5_4()
	...
	nil, 1000, 700, cinematicName .. ".narratorLineTrauma5_5()")
end
...
function narratorLineTrauma5_6()
	...
	nil, 4000, 700, cinematicName .. ".narratorLineTrauma5_7()")
end
...
function narratorLineTrauma6_4()
	...
	nil, 4000, 700, cinematicName .. ".narratorLineTrauma6_5()")
end
...
function narratorLineTrauma6_6()
	...
	nil, 6000, 700, cinematicName .. ".narratorLineTrauma6_7()")
end
...
function narratorLineTrauma7_2()
	...
	nil, 3000, 700, cinematicName .. ".narratorLineTrauma7_3()")
end
...
function narratorLineTrauma7_5()
	...
	nil, 3000, 700, cinematicName .. ".narratorLineTrauma7_6()")
end
...
function narratorLineTrauma8_2()
	...
	nil, 4000, 700, cinematicName .. ".narratorLineTrauma8_3()")
end
...
function narratorLineTrauma8_5()
	cinematic.CinematicUtil.playSpeech("Play_protecting_01_01_shadwen",
	nil, 4000, 700, cinematicName .. ".narratorLineTrauma8_6()")
end

function narratorLineTrauma8_6()
	cinematic.CinematicUtil.playSpeech("Play_protecting_01_02_lily",
	nil, 3000, 700, cinematicName .. ".narratorLineTrauma8_7()")
end
...
function narratorLineTrauma8_8()
	cinematic.CinematicUtil.playSpeech("Play_protecting_01_04_lily",
	nil, 2000, 700, cinematicName .. ".narratorLineTrauma8_9()")
end

function narratorLineTrauma8_9()
	cinematic.CinematicUtil.playSpeech("Play_protecting_01_05_lily",
	nil, 6000, 700, cinematicName .. ".narratorLineTrauma8_10()")
end

function narratorLineTrauma8_10()
	cinematic.CinematicUtil.playSpeech("Play_protecting_01_06_lily",
	nil, 4000, 700, cinematicName .. ".narratorLineTrauma8_11()")
end
...
function narratorLineNoTrauma1()
	cinematic.CinematicUtil.playSpeech("Play_lilystory_07_01_shadwen",
	nil, 1000, 700, cinematicName .. ".narratorLineNoTrauma2()")
end

function narratorLineNoTrauma2()
	cinematic.CinematicUtil.playSpeech("Play_lilystory_07_02_lily", 
	nil, 7000, 700, cinematicName .. ".narratorLineNoTrauma3()")
end

function narratorLineNoTrauma3()
	cinematic.CinematicUtil.playSpeech("Play_lilystory_07_03_lily", 
	nil, 1000, 700, cinematicName .. ".narratorLineNoTrauma4()")
end

function narratorLineNoTrauma4()
	cinematic.CinematicUtil.playSpeech("Play_lilystory_07_04_shadwen", 
