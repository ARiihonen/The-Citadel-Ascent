...
all_languages = 
{
	...
	-- , { id = "br", nativeName = "Português (BR)", englishName = "Brazilian Portuguese", audioName = "portuguese_brazil_/"}
	-- , { id = "ru", nativeName = "Русский", englishName = "Russian", audioName = "russian/", useCompatibilityFont = true, useCompatibilityFont2 = false }
	-- , { id = "sv", nativeName = "Svenska", englishName = "Swedish", audioName = "swedish/"}
	-- , { id = "nn", nativeName = "Norsk", englishName = "Norwegian", audioName = "norwegian/"}
	-- , { id = "da", nativeName = "Dansk", englishName = "Danish", audioName = "danish/"}
	...
	-- , { id = "fi", nativeName = "Suomi", englishName = "Finnish", audioName = "finnish/" }
	-- , { id = "tr", nativeName = "Türkçe", englishName = "Turkish", audioName = "turkish/" }
}
...
function initLanguagesPerPlatformOrBuild()
	...
	if FB_BUILD == "FB_FINAL_RELEASE" then
		-- Define here what languages should be in the FINAL builds
